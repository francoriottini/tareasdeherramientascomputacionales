...
´´´Este código es para generar un archivo raster por países que incluya la mean popd de 1800, 1900 y 2000.
Se utiliza el shp de: http://www.naturalearthdata.com/downloads/%2010m-cultural-vectors/10m-admin-0-countries/ 
para los países. 
Raster de: https://dataportaal.pbl.nl/downloads/HYDE/HYDE3.0/ 
