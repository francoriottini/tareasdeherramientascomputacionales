...
class Model3(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'INPUT_RASTER': 'landquality_19a06321_f915_45c1_8741_e156742b9baa',
            'RASTER_BAND': 1,
            'STATISTICS': [2],  # Mean
        ...
        alg_params = {
            ...
            'INPUT_RASTER': 'popd_1900AD_909d2ce0_1ec7_45e6_96bf_ee499df268ea',
            'RASTER_BAND': 1,
            'STATISTICS': [2],  # Mean
        ...
        alg_params = {
            ...
            'INPUT_RASTER': 'popd_1800AD_2dfdecf5_d20f_4f85_ad5e_a81c48c744a5',
            'RASTER_BAND': 1,
            'STATISTICS': [2],  # Mean
        ...
        alg_params = {
            'DATASOURCE_OPTIONS': '',
            'INPUT': 'Estadistica_zonal_34814cdd_3371_42d8_95a4_761e0953a3a2',
            'LAYER_NAME': '',
            'LAYER_OPTIONS': '',
        ...
        alg_params = {
            ...
            'INPUT_RASTER': 'popd_2000AD_09e35551_147e_4753_bbff_dbd6ff5df28a',
            'RASTER_BAND': 1,
            'STATISTICS': [2],  # Mean
